...
\begin{proof}
    ...
    Let $x$ be the generic point of an irreducible component of the closure of $\supp H^{k}(\sheaf F)$.
    ...
    Let $Z$ be the closure of $\supp H^k(\lc {\overline x}\sheaf F)$.
...
\item 
    ...
    \begin{multline*}
        ...
        -p(x) - k.
    \end{multline*}
    Otherwise $\overline x ∩ \overline{\supp\left( H^k(\dualize F) \right)} = \overline y$ for some $y ∈ X^{\mathrm{top}}$ with $\dim y < \dim x$.
