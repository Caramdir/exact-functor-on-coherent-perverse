...
% proof: represent by a perfect complex and resolve by currents.
...
\begin{proof}
    Since the question is local, we can assume that $X$ affine and set $X = \Spec A$.\remark{Can we really assume that?}
