...
We further set $\mathbf ι_x^!\sheaf F = \mathbf ι_x^*\lc {\overline x}$.
...
\begin{proof}
    ...
    If $\supp \lc {\overline x} = \overline x$, then $H^k(\mathbf ι_x^!\sheaf F) = H^k(\mathbf ι_x^*\lc {\overline x} \sheaf F)$ vanishes if and only if $H^k(\lc {\overline x})$ vanishes and we are done.
    If $\supp \lc {\overline x} ⊆ \overline x$ then the implication follows by induction and monotonicity of the perversity.
