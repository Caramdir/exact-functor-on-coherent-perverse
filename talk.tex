...
In general the (exceptional) pull-back and push-forward functors are not t-exact with respect to the perverse t-structure (see however, e.g., \cite[Corollary~8.1.44] for cases where they are exact).
